...
default_args = {
  ...
  'topics' : 'icisco-network-mainstream', # *************** This is one of the topic you created in SYSTEM STEP 2
  'identifier' : 'TML solution',  
  'mqtt_broker' : 'f60f0f8d72b045568bd5ac7854c9495c.s1.eu.hivemq.cloud' # <<<****** Enter MQTT broker i.e. test.mosquitto.org
...
@dag(dag_id="tml_mqtt_step_3_kafka_producetotopic_dag_pradipprivategpt-4b2d", default_args=default_args, tags=["tml_mqtt_step_3_kafka_producetotopic_dag_pradipprivategpt-4b2d"], schedule=None,catchup=False)
