...
default_args = {
 ...
 'solutionname': 'pradip-4b2d',   # <<< *** DO NOT MODIFY - THIS WILL BE AUTOMATICALLY UPDATED
...
@dag(dag_id="tml_system_step_1_getparams_dag_pradip-4b2d", default_args=default_args, tags=["tml_system_step_1_getparams_dag_pradip-4b2d"], schedule=None, catchup=False)
def tmlparams():
    # Define tasks
    def empty():
        pass
