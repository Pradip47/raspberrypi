...
step3 = importlib.import_module("tml-solutions.pradip-4b2d.tml_read_gRPC_step_3_kafka_producetotopic_dag-pradip-4b2d")
...
with DAG(
    dag_id="solution_preprocessing_ml_ai_grpc_dag-pradip-4b2d",
